...
from rlkit.envs.baby_mode_wrapper import BabyModeWrapper
...
def experiment(variant):
    ...
    obs_dim = int(np.prod(sawyer_env.observation_space.shape))
    action_dim = int(np.prod(sawyer_env.action_space.shape))
    latent_dim = 7
