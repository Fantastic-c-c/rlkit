...
from rlkit.envs.wheeled import WheeledEnv
...
def experiment(variant):
    env = NormalizedBoxEnv(WheeledEnv(**variant['task_params']))
...
def main(gpu, docker):
    ...
    exp_name = 'proto-sac-wheeled-sparse-1task-50traj'

    log_dir = '/mounts/output' if docker == 1 else 'output'
    experiment_log_dir = setup_logger(exp_name, variant=variant, exp_id='wheeled', base_log_dir=log_dir)
