"""
Run Prototypical Soft Actor Critic on WalkerRandParams.
...
def experiment(variant):
    ...
    env = NormalizedBoxEnv(WalkerRandParamsWrappedEnv(n_tasks=task_params['n_tasks']))
...
def main(gpu, docker):
    ...
    exp_name = 'no-rf-final/walker/{}'.format(gpu)

    log_dir = '/mounts/output' if docker == 1 else 'output'
    experiment_log_dir = setup_logger(exp_name, variant=variant, exp_id='walker-rand-params', base_log_dir=log_dir)
