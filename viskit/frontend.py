...
def make_plot(
    ...
    for y_idx, plot_list in enumerate(plot_lists):
        for idx, plt in enumerate(plot_list):
            color = core.color_defaults[y_idx % len(core.color_defaults)] # I changed this
        ...
        for plot_key in plot_keys:
            ...
            for group_selector, group_legend in zip(group_selectors, group_legends):
                ...
                if only_show_best or only_show_best_sofar:
                    ...
                    print("GROUP LEGEND: " + str(plot_key))
                    to_plot.append(
                        AttrDict(
                            legend=legend_post_processor(plot_key), # I changed this
                            plot_key=plot_key,
                            **statistics
                        )
                    )
