        ...
        for it_ in gt.timed_for(
            ...
            if it_ == 0:
                ...
                for idx in self.train_tasks:
                    ...
                    self.collect_data(10 * self.max_path_length, self.max_path_length, 10 * self.max_path_length, self.embedding_batch_size, eval_task=False)
            ...
            for i in range(self.num_tasks_sample):
                ...
                if self.train_embedding_source == 'initial_pool':
                    ...
                    self.enc_replay_buffer.task_buffers[idx].clear()
                    self.collect_data(self.max_path_length * 5 + 1, self.resample_z_train, np.inf, self.embedding_batch_size, eval_task=False)
