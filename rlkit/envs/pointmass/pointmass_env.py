...
class PointMassEnvMultitask(PointMassEnv):
    ...
    def get_obs_dim(self):
        return len(self.get_obs())  # the additional dims for reward and sparse reward  ####new:not adding the 2
    ...
    def reset_task(self, idx):
        ...
        self._state_goal = self._task ##########new: dummy, since it's called in rl_algo line 369 collect path
