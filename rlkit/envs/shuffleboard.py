...
@register_env('SawyerShuffleboard')
class SawyerSweepEnv(SawyerXYZEnv):
    def __init__(
        ...
        self.image_dim = self._get_obs().shape[1] ##############new

        self._goal = self._state_goal
    ...
    def step(self, action):
        ...
        info = {'reachDist': reachDist, 'goalDist': pushDist, 'epRew': reward, 'pickRew': None,
